...
@Component
public class WebSocketSessionListnerManager {
    ...
    public WebSocketSessionListnerManager(StompMessagingService stompMessagingService) {
    ...
    public void handleSessionConnected(SessionConnectedEvent event) {
        ...
        log.info("user headerAccessor: {} ", headerAccessor.getSessionId());
